            ...
            <form onSubmit={handleSubmit} className="block w-[90%] sm:w-[80%] md:w-[60%] lg:w-[90%] xl:w-[80%]">
              <div className="mb-4">
                ...
                <input
                  ...
                  className="px-4 py-4 w-full rounded-lg bg-gray-100 backdrop-blur-3xl block outline-none"
              ...
              <LoadingButton size={"lg"} className="w-full mt-3 gradient-btn" isLoading={isLoading}>
                Sign Up
              </LoadingButton>
            </form>
