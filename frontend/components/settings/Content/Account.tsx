...
const Account = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center p-4">
      ...
      <div className="bg-white w-[64%] mt-4 rounded-md ">
        ...
        <div className="pl-4 py-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-[18px] font-medium text-red-600">Danger Zone</h3>
          </div>
          <div className="flex w-full items-center justify-between">
            <div>
              <p className="text-gray-700 font-medium">Delete account</p>
              <p className="text-sm text-gray-500">Permanently delete or deactivate your account</p>
            </div>
            <button
      ...
      {showDeleteModal && <DeleteAccountModal setShowDeleteModal={setShowDeleteModal} />}
    </div>
  );
};
